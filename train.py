...
def plot_predict_xtest(x_test, y_test, y_pred):
    ...
    for i in range(0, 10):
        ...
        axs[0, i].set_title("Label: {}, Pred: {}".format(label_true, label_pred), fontsize = 14)
        sample = x_test[y_test == i][0]
        label_true = y_test[y_test == i][0]
        label_pred = y_pred[y_test == i][0]
        axs[1, i].imshow(sample, cmap = 'gray')
        axs[1, i].set_title("Label: {}, Pred: {}".format(label_true, label_pred), fontsize = 14)
    return fig
...
def plot_confusion_matrix(confusion_mtx):
    ...
    ax = sns.heatmap(confusion_mtx, annot = True, fmt = 'd', ax = ax, cmap = "Blues", cbar = False, linewidths = .2, linecolor="grey", annot_kws={"fontsize":16})
...
def run_NN():
    ...
    test_score, y_pred, confusion_mtx = model_performance(model, x_test, y_test)
    model.save("./models/NN.h5")
    fig = plot_original_xtrain(x_train, y_train)
    fig.savefig("./static/images/NN_original_xtrain.png", bbox_inches = 'tight', pad_inches = 0)
    fig = plot_accuracy(history, round(test_score[1], 4))
    fig.savefig("./static/images/NN_accuracy.png", bbox_inches = 'tight', pad_inches = 0)
    fig = plot_loss(history, round(test_score[0], 4))
    fig.savefig("./static/images/NN_loss.png", bbox_inches = 'tight', pad_inches = 0)
    fig = plot_predict_xtest(x_test, y_test, y_pred)
    fig.savefig("./static/images/NN_predict_xtest.png", bbox_inches = 'tight', pad_inches = 0)
    fig = plot_confusion_matrix(confusion_mtx)
    fig.savefig("./static/images/NN_confusion_matrix.png", bbox_inches = 'tight', pad_inches = 0)
...
def run_CNN():
    ...
    fig = plot_original_xtrain(x_train, y_train)
    fig.savefig("./static/images/CNN_original_xtrain.png", bbox_inches = 'tight', pad_inches = 0)
    fig = plot_accuracy(history, round(test_score[1], 4))
    fig.savefig("./static/images/CNN_accuracy.png", bbox_inches = 'tight', pad_inches = 0)
    fig = plot_loss(history, round(test_score[0], 4))
    fig.savefig("./static/images/CNN_loss.png", bbox_inches = 'tight', pad_inches = 0)
    fig = plot_predict_xtest(x_test, y_test, y_pred)
    fig.savefig("./static/images/CNN_predict_xtest.png", bbox_inches = 'tight', pad_inches = 0)
    fig = plot_confusion_matrix(confusion_mtx)
    fig.savefig("./static/images/CNN_confusion_matrix.png", bbox_inches = 'tight', pad_inches = 0)
...
def run_NN2():
    ...
    fig = plot_original_xtrain(x_train, y_train)
    fig.savefig("./static/images/NN2_original_xtrain.png", bbox_inches = 'tight', pad_inches = 0)
    fig = plot_accuracy(history, round(test_score[1], 4))
    fig.savefig("./static/images/NN2_accuracy.png", bbox_inches = 'tight', pad_inches = 0)
    fig = plot_loss(history, round(test_score[0], 4))
    fig.savefig("./static/images/NN2_loss.png", bbox_inches = 'tight', pad_inches = 0)
    fig = plot_predict_xtest(x_test, y_test, y_pred)
    fig.savefig("./static/images/NN2_predict_xtest.png", bbox_inches = 'tight', pad_inches = 0)
    fig = plot_confusion_matrix(confusion_mtx)
    fig.savefig("./static/images/NN2_confusion_matrix.png", bbox_inches = 'tight', pad_inches = 0)
...
def run_CNN2():
    ...
    fig = plot_original_xtrain(x_train, y_train)
    fig.savefig("./static/images/CNN2_original_xtrain.png", bbox_inches = 'tight', pad_inches = 0)
    fig = plot_accuracy(history, round(test_score[1], 4))
    fig.savefig("./static/images/CNN2_accuracy.png", bbox_inches = 'tight', pad_inches = 0)
    fig = plot_loss(history, round(test_score[0], 4))
    fig.savefig("./static/images/CNN2_loss.png", bbox_inches = 'tight', pad_inches = 0)
    fig = plot_predict_xtest(x_test, y_test, y_pred)
    fig.savefig("./static/images/CNN2_predict_xtest.png", bbox_inches = 'tight', pad_inches = 0)
    fig = plot_confusion_matrix(confusion_mtx)
    fig.savefig("./static/images/CNN2_confusion_matrix.png", bbox_inches = 'tight', pad_inches = 0)
