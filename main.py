...
def parseImg(imgData):
    ...
    canvas_img_url = "https://storage.cloud.google.com/stone-resource-311918-bucket/{}".format(file_name)
    ...
    process_img_url = "https://storage.cloud.google.com/stone-resource-311918-bucket/{}".format(file_name) 
